...
#     launch_file_dir = os.path.join(get_package_share_directory('amar_simulation'), 'launch')
...
#     set_env_vars_resources_w = AppendEnvironmentVariable(
#             name="GZ_SIM_RESOURCE_PATH",
#             value=join(launch_file_dir, "worlds")
#         )
#     set_env_vars_resources_m = AppendEnvironmentVariable(
#             name="GZ_SIM_RESOURCE_PATH",
#             value=join(launch_file_dir, "models")
#         )
...
#     ld.add_action(set_env_vars_resources_w)
#     ld.add_action(set_env_vars_resources_m)
